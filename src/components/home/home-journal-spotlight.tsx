    ...
    <>
      ...
      <section className="mx-auto max-w-[1240px] px-6 pt-26  md:px-16 md:pt-10 lg:px-0">
        ...
        <div className="mt-5 flex flex-col md:flex-row  justify-between gap-6">
          ...
          <p className="text-[12px] font-bold uppercase leading-[1.8] tracking-[0.1em] text-slate-400 md:max-w-[400px] ">
      ...
      `}</style>
        ...
        >
          ...
          <h2
            className="relative z-10 max-w-[350px] text-[34px] md:text-[42px] leading-10   tracking-[-0.05em] text-[#171717] "
            style={{
              fontFamily:
                'var(--font-elms-sans), "Helvetica Neue", Helvetica, Arial, sans-serif',
            }}
        ...
        <div className="absolute inset-x-0 top-[200px] space-y-7 z-0 lg:relative lg:col-span-2 lg:top-0 lg:grid lg:grid-cols-[1fr_230px]">
          <div
